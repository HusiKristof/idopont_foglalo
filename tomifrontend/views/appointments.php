...
if ($action === 'book') {
    ...
    $query = "SELECT a.appointment_date, p.name AS provider_name, p.type AS provider_type FROM appointments a JOIN providers p ON a.provider_id = p.id WHERE a.user_id = ?";
